...
func (u *UserHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	err := u.UserService.CreateUser(context.Background(), &us)
	if err != nil {
...
func (u *UserHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := u.UserService.UpdateUser(context.Background(), &updatedUser); err != nil {
...
func (u *UserHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := u.UserService.DeleteUser(context.Background(), id); err != nil {
...
func (u *UserHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	users, err := u.UserService.ListUsers(context.Background(), limit, offset)
	if err != nil {
