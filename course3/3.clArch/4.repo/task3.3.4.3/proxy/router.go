...
import (
	...
	"geoservicecache/proxy/internal/controller" //"usr/local/go/src/clean-architecture-logic-isolation/internal/controller"
	"geoservicecache/proxy/internal/service"    //"usr/local/go/src/clean-architecture-logic-isolation/internal/service"
