...
import (
	...
	"geoservicemetrics/proxy/internal/controller" //"usr/local/go/src/clean-architecture-logic-isolation/internal/controller"
	"geoservicemetrics/proxy/internal/metrics"
	"geoservicemetrics/proxy/internal/service" //"usr/local/go/src/clean-architecture-logic-isolation/internal/service"
